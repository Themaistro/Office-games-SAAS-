...
export default function CardMatchGame({ question, onAnswer, isSubmitting, showHint }: GameComponentProps) {
  ...
  // Easy: 8 cards, Medium: 12 cards, Hard: 16 cards (as generated by game-content.ts)
  ...
  const totalCards = question?.content?.cards?.length || 12;
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className={clsx(
        "grid gap-3 w-full max-w-sm mx-auto mb-8",
        totalCards === 8 ? "grid-cols-4" : 
        totalCards === 16 ? "grid-cols-4" :
